...
def _build_replay_compare(today_bundle: dict[str, SummaryRecord], previous_bundle: dict[str, SummaryRecord]) -> dict[str, Any]:
    metrics = {
        ...
        "shadow_gate_passed_count": "count_only",
        "shadow_candidate_count": "count_only",
        "shadow_verified_count": "count_only",
        "shadow_blocked_count": "count_only",
        "shadow_missing_field_reasons": "object",
        "shadow_reason_distribution": "object",
        "shadow_score_distribution": "object",
        "replay_profile_blocker_count": "count_only",
        "sampled_negative_profiles": "object",
        "blocker_grade_negative_profiles": "object",
        "high_confidence_negative_profiles": "object",
        "high_confidence_positive_profiles": "object",
        "low_sample_positive_profiles": "object",
        "low_sample_profiles_count": "count_only",
        "profile_unknown_diagnostics": "object",
        "current_strategy_config": "object",
    ...
    source_map = {
        ...
        "shadow_gate_passed_count": (today_shadow, previous_shadow),
        "shadow_candidate_count": (today_shadow, previous_shadow),
        "shadow_verified_count": (today_shadow, previous_shadow),
        "shadow_blocked_count": (today_shadow, previous_shadow),
        "shadow_missing_field_reasons": (today_shadow, previous_shadow),
        "shadow_reason_distribution": (today_shadow, previous_shadow),
        "shadow_score_distribution": (today_shadow, previous_shadow),
        "replay_profile_blocker_count": (today_replay, previous_replay),
        "sampled_negative_profiles": (today_replay, previous_replay),
        "blocker_grade_negative_profiles": (today_replay, previous_replay),
        "high_confidence_negative_profiles": (today_replay, previous_replay),
        "high_confidence_positive_profiles": (today_replay, previous_replay),
        "low_sample_positive_profiles": (today_replay, previous_replay),
        "low_sample_profiles_count": (today_replay, previous_replay),
        "profile_unknown_diagnostics": (today_replay, previous_replay),
        "current_strategy_config": (today_replay, previous_replay),
