...
- selected a fully covered Beijing afternoon-evening window from 2026-04-21 13:00:02 UTC+08:00 to 2026-04-21 13:56:14 UTC+08:00 (0.94h); raw/parsed/signals/delivery/cases all overlap in this interval.
- LP sample size in the selected window is 3 rows with 0 delivered LP Telegram messages.
- Telegram denoise is materially active: delivered/raw ratio is 0.0, suppression ratio is 1.0, and suppression reasons are dominated by {'no_trade_opportunity': 3}.
- asset-level market state is live in real data: 2 state changes, distribution {'DO_NOT_CHASE_LONG': 1, 'OBSERVE_LONG': 2}, final states {'ETH': {'state_key': 'OBSERVE_LONG', 'state_label': '偏多观察', 'updated_at': 1776748136, 'updated_at_utc': '2026-04-21 05:08:56 UTC', 'updated_at_beijing': '2026-04-21 13:08:56 UTC+08:00', 'telegram_update_kind': 'suppressed'}}.
- NO_TRADE_LOCK is real rather than theoretical: entered=0 suppressed=0 released=0.
- prealert lifecycle evidence is limited in this window: prealert stage rows=0, first_seen_stage=prealert count=2, median_prealert_to_confirm_sec=0.0.
...
- outcome price sourcing shifted away from prior pool_quote_proxy-heavy behavior: current sources={'okx_mark': 9}, previous pool_quote_proxy share=0.0, current share=0.0.

## 2. 数据源与完整性说明

- `app/data/archive/raw_events/2026-04-20.ndjson` | records=`4171` | range_utc=`2026-04-20 15:03:51 UTC -> 2026-04-20 15:59:52 UTC` | range_bj=`2026-04-20 23:03:51 UTC+08:00 -> 2026-04-20 23:59:52 UTC+08:00` | window_records=`` | note=`raw_events archive`
- `app/data/archive/raw_events/2026-04-21.ndjson` | records=`43792` | range_utc=`2026-04-20 16:00:05 UTC -> 2026-04-21 05:56:14 UTC` | range_bj=`2026-04-21 00:00:05 UTC+08:00 -> 2026-04-21 13:56:14 UTC+08:00` | window_records=`1968` | note=`raw_events archive`
- `app/data/archive/parsed_events/2026-04-20.ndjson` | records=`1921` | range_utc=`2026-04-20 15:03:51 UTC -> 2026-04-20 15:59:50 UTC` | range_bj=`2026-04-20 23:03:51 UTC+08:00 -> 2026-04-20 23:59:50 UTC+08:00` | window_records=`` | note=`parsed_events archive`
- `app/data/archive/parsed_events/2026-04-21.ndjson` | records=`23985` | range_utc=`2026-04-20 16:00:05 UTC -> 2026-04-21 05:56:14 UTC` | range_bj=`2026-04-21 00:00:05 UTC+08:00 -> 2026-04-21 13:56:14 UTC+08:00` | window_records=`1968` | note=`parsed_events archive`
...
- `app/data/archive/signals/2026-04-20.ndjson` | records=`76` | range_utc=`2026-04-20 15:03:53 UTC -> 2026-04-20 15:56:39 UTC` | range_bj=`2026-04-20 23:03:53 UTC+08:00 -> 2026-04-20 23:56:39 UTC+08:00` | window_records=`` | note=`signals archive`
- `app/data/archive/signals/2026-04-21.ndjson` | records=`450` | range_utc=`2026-04-20 16:00:15 UTC -> 2026-04-21 05:53:12 UTC` | range_bj=`2026-04-21 00:00:15 UTC+08:00 -> 2026-04-21 13:53:12 UTC+08:00` | window_records=`5` | note=`signals archive`
...
- `app/data/archive/delivery_audit/2026-04-20.ndjson` | records=`4260` | range_utc=`2026-04-20 15:03:51 UTC -> 2026-04-20 15:59:52 UTC` | range_bj=`2026-04-20 23:03:51 UTC+08:00 -> 2026-04-20 23:59:52 UTC+08:00` | window_records=`` | note=`delivery_audit archive`
- `app/data/archive/delivery_audit/2026-04-21.ndjson` | records=`44724` | range_utc=`2026-04-20 16:00:05 UTC -> 2026-04-21 05:56:14 UTC` | range_bj=`2026-04-21 00:00:05 UTC+08:00 -> 2026-04-21 13:56:14 UTC+08:00` | window_records=`1968` | note=`delivery_audit archive`
...
- `app/data/archive/cases/2026-04-20.ndjson` | records=`2378` | range_utc=`2026-04-20 15:03:51 UTC -> 2026-04-20 15:59:50 UTC` | range_bj=`2026-04-20 23:03:51 UTC+08:00 -> 2026-04-20 23:59:50 UTC+08:00` | window_records=`` | note=`cases archive`
- `app/data/archive/cases/2026-04-21.ndjson` | records=`34950` | range_utc=`2026-04-20 16:00:05 UTC -> 2026-04-21 05:56:14 UTC` | range_bj=`2026-04-21 00:00:05 UTC+08:00 -> 2026-04-21 13:56:14 UTC+08:00` | window_records=`2893` | note=`cases archive`
...
- `app/data/archive/case_followups/2026-04-20.ndjson` | records=`5` | range_utc=`2026-04-20 15:21:28 UTC -> 2026-04-20 15:39:05 UTC` | range_bj=`2026-04-20 23:21:28 UTC+08:00 -> 2026-04-20 23:39:05 UTC+08:00` | window_records=`` | note=`case_followups archive`
- `app/data/archive/case_followups/2026-04-21.ndjson` | records=`67` | range_utc=`2026-04-20 16:05:52 UTC -> 2026-04-21 05:27:41 UTC` | range_bj=`2026-04-21 00:05:52 UTC+08:00 -> 2026-04-21 13:27:41 UTC+08:00` | window_records=`1` | note=`case_followups archive`
- `data/lp_quality_stats.cache.json` | records=`791` | range_utc=`2026-04-17 06:16:14 UTC -> 2026-04-21 05:08:58 UTC` | range_bj=`2026-04-17 14:16:14 UTC+08:00 -> 2026-04-21 13:08:58 UTC+08:00` | window_records=`` | note=`quality stats cache`
- `data/asset_cases.cache.json` | records=`1` | range_utc=`2026-04-21 05:08:38 UTC -> 2026-04-21 05:08:56 UTC` | range_bj=`2026-04-21 13:08:38 UTC+08:00 -> 2026-04-21 13:08:56 UTC+08:00` | window_records=`` | note=`asset case snapshot cache`
- `data/asset_market_states.cache.json` | records=`1` | range_utc=`2026-04-20 05:10:15 UTC -> 2026-04-21 05:08:58 UTC` | range_bj=`2026-04-20 13:10:15 UTC+08:00 -> 2026-04-21 13:08:58 UTC+08:00` | window_records=`` | note=`asset market state cache`
- `data/trade_opportunities.cache.json` | records=`136` | range_utc=`2026-04-20 15:03:51 UTC -> 2026-04-21 05:13:52 UTC` | range_bj=`2026-04-20 23:03:51 UTC+08:00 -> 2026-04-21 13:13:52 UTC+08:00` | window_records=`` | note=`trade opportunity cache`
- `data/chain_monitor.sqlite` | records=`250877` | range_utc=` -> ` | range_bj=` -> ` | window_records=`` | note=`sqlite mirror/query layer report_data_source=sqlite sqlite_rows_by_table={'schema_meta': 1, 'runs': 0, 'raw_events': 47964, 'parsed_events': 25907, 'signals': 972, 'signal_features': 3208, 'market_context_snapshots': 972, 'market_context_attempts': 1107, 'outcomes': 2421, 'asset_cases': 1, 'asset_market_states': 223, 'no_trade_locks': 145, 'trade_opportunities': 150, 'opportunity_outcomes': 450, 'quality_stats': 816, 'telegram_deliveries': 59485, 'prealert_lifecycle': 972, 'delivery_audit': 105976, 'case_followups': 107} archive_rows_by_category={'raw_events': 47963, 'parsed_events': 25906, 'signals': 972, 'delivery_audit': 105976, 'cases': 79020, 'case_followups': 107} db_archive_mirror_match_rate=1.0 archive_fallback_used=False mismatch_warnings=['db_archive_mirror_mismatch:raw_events:sqlite=47964:archive=47963', 'db_archive_mirror_mismatch:parsed_events:sqlite=25907:archive=25906']`

## 3. 北京时间下午到晚上分析窗口

- `cutoff_beijing=2026-04-21 13:00:00 UTC+08:00`
- `analysis_window_utc=2026-04-21 05:00:02 UTC -> 2026-04-21 05:56:14 UTC`
- `analysis_window_server=2026-04-21 05:00:02 UTC -> 2026-04-21 05:56:14 UTC`
- `analysis_window_beijing=2026-04-21 13:00:02 UTC+08:00 -> 2026-04-21 13:56:14 UTC+08:00`
- `duration_hours=0.94`
...
- `state_distribution={'DO_NOT_CHASE_LONG': 1, 'OBSERVE_LONG': 2}`
- `state_transition_count=2` `state_changed_count=2`
- `repeated_state_suppressed_count=0`
- `final_state_by_asset={'ETH': {'state_key': 'OBSERVE_LONG', 'state_label': '偏多观察', 'updated_at': 1776748136, 'updated_at_utc': '2026-04-21 05:08:56 UTC', 'updated_at_beijing': '2026-04-21 13:08:56 UTC+08:00', 'telegram_update_kind': 'suppressed'}}`
- `eth_state_path=[{'ts': 1776748121, 'utc': '2026-04-21 05:08:41 UTC', 'beijing': '2026-04-21 13:08:41 UTC+08:00', 'state_key': 'DO_NOT_CHASE_LONG', 'previous_state_key': 'OBSERVE_LONG', 'reason': '局部买压可能被吸收，不宜把单池压力误读成可以追多。', 'trade_action_key': 'DO_NOT_CHASE_LONG', 'lp_alert_stage': 'confirm', 'telegram_update_kind': 'suppressed'}, {'ts': 1776748136, 'utc': '2026-04-21 05:08:56 UTC', 'beijing': '2026-04-21 13:08:56 UTC+08:00', 'state_key': 'OBSERVE_LONG', 'previous_state_key': 'DO_NOT_CHASE_LONG', 'reason': '局部买压/买方清扫建立中，但还没到可以追多的严格条件。', 'trade_action_key': 'LONG_BIAS_OBSERVE', 'lp_alert_stage': 'confirm', 'telegram_update_kind': 'suppressed'}]`

## 6. Telegram 降噪与 suppression 分析

- `messages_before_suppression_estimate=3` `messages_after_suppression_actual=0`
- `telegram_should_send_count=0` `telegram_suppressed_count=3`
- `telegram_suppression_ratio=1.0`
- `telegram_suppression_reasons={'no_trade_opportunity': 3}`
- `telegram_update_kind_distribution={'suppressed': 3}`
...
- `prealert_count=0`
- `prealert_candidate_count=2`
- `prealert_gate_passed_count=2`
- `prealert_active_count=0`
- `prealert_delivered_count=0`
- `prealert_merged_count=1`
- `prealert_upgraded_to_confirm_count=2`
- `prealert_expired_count=0`
- `prealert_suppressed_by_lock_count=0`
- `median_prealert_to_confirm_sec=0.0`
- `first_seen_stage_prealert_count=2`
- `prealert_stage_overwritten_count=2`
- `first_seen_stage_distribution={'prealert': 3}`
...
- `opportunity_score_median=0.5136` `opportunity_score_p90=0.6476`
...
- `window_status_distribution={'30s': {'expired': 1, 'pending': 2}, '60s': {'expired': 1, 'pending': 2}, '300s': {'expired': 1, 'pending': 2}}`
- `outcome_price_source_distribution={'okx_mark': 9}`
- `outcome_failure_reason_distribution={'window_elapsed_without_price_update': 3}`
- `scheduler_health_summary={'pending_count': 6, 'completed_count': 0, 'unavailable_count': 0, 'expired_count': 3, 'catchup_completed_count': 0, 'catchup_expired_count': 0, 'settled_by_distribution': {}}`
- `expired_rate_by_window={'30s': 0.3333, '60s': 0.3333, '300s': 0.3333}`
- previous baseline `source_distribution={'okx_mark': 544}`
- `pool_quote_proxy_share_delta_vs_previous=0.0`

## 11. OKX/Kraken live market context 分析

- window `live_public_count=3` `unavailable_count=0`
- window `okx_attempts=18` `okx_success=18` `okx_failure=0`
- window `kraken_attempts=0` `kraken_success=0` `kraken_failure=0`
- window `requested_to_resolved_distribution={'ETHUSDC->ETH-USDT-SWAP': 2, 'ETHUSDT->ETH-USDT-SWAP': 1}`
- CLI full `live_public_hit_rate=0.2181` `unavailable_rate=0.7819`

## 12. trade_action 与交易辅助价值分析

- `trade_action_distribution={'DO_NOT_CHASE_LONG': 1, 'LONG_BIAS_OBSERVE': 2}`
...
- `buy_pressure_adverse_30s_rate=None`
- `buy_pressure_adverse_60s_rate=None`
- `buy_pressure_adverse_300s_rate=None`
...
- `asset_distribution={'ETH': 3}`
- `pair_distribution={'ETH/USDC': 2, 'ETH/USDT': 1}`
