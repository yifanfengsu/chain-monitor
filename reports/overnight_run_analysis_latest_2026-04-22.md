...
- `data/chain_monitor.sqlite`: exists=`True` records=`1633` range=`2026-04-18 05:26:52 UTC -> 2026-04-22 05:21:54 UTC` note=`sqlite signals mirror via report_data_loader`
...
- CLI full archive live_public_hit_rate = `0.2498`
- CLI full archive per_venue = `[{'attempt_failure': 1, 'attempt_failure_rate': 0.0004, 'attempt_hit_rate': 0.9996, 'attempt_status_cache_hit': 33, 'attempt_status_failure': 1, 'attempt_status_success': 2249, 'attempt_success': 2249, 'attempt_total': 2250, 'cache_hit_rate': 0.0809, 'cache_hit_total': 33, 'context_request_hit_rate': 1.0, 'signal_hit_rate': 1.0, 'signal_success': 408, 'signal_total': 408, 'timeout_count': 1, 'venue': 'okx_perp', 'venue_attempt_success_rate': 0.9996}]`
