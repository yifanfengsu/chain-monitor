...
require_out "daily_report字段存在性=lp_signal_summary=missing；lp_signals=missing；lp_stage_summary=missing；clmm_summary=missing；major_coverage_summary=present"
